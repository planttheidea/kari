...
const mergeArrays = (array1, array2) =>
  (array2.length >= array1.length ? array2.slice(0) : array2.concat(array1.slice(array2.length)));
...
export default curry(function merge(collection1, collection2) {
  ...
  const mergeMethod = Array.isArray(normalized1) && Array.isArray(normalized2) ? mergeArrays : assign;
