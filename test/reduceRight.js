...
test('if reduceRight will perform a reduction based on the items and initialValue passed (curried)', (t) => {
...
test('if reduceRight will perform a reduction based on the items and initialValue passed (full arity)', (t) => {
  const diff = (total, num) => {
    return total - num;
  };
